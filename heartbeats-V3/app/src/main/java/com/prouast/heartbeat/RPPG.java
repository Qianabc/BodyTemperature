...
//    }
    ...
    public double temperature(int age,double measure_time_diff, double sleep_time_diff, int modechoose, int hr_standard,
                              int gender_flag, double measure_interval, double store_bpms, double store_te, double now_bpms){
        return _temperature(self, age, measure_time_diff, sleep_time_diff, modechoose, hr_standard, gender_flag, measure_interval, store_bpms, store_te, now_bpms);
    }

    private long self = 0;
    private static native long _initialise();
    private native double _outputreference(long self);
//    private native double _temperature(long self, int age, double measure_time_diff, double sleep_time_diff, int modechoose, int hr_standard,
//                                       int gender_flag, double measure_interval, double store_bpms, double store_te, double now_bpms);
    private native double _temperature(long self, int age,double measure_time_diff, double sleep_time_diff, int modechoose, int hr_standard,
                                       int gender_flag, double measure_interval, double store_bpms, double store_te, double now_bpms);
