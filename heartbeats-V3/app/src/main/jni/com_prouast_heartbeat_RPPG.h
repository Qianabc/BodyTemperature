...
JNIEXPORT void JNICALL Java_com_prouast_heartbeat_RPPG__1load
  (JNIEnv *, jclass, jlong, jobject, jint, jint, jint, jint, jint, jint, jdouble, jint, jdouble, jdouble, jint, jint, jstring, jstring, jboolean, jboolean);
...
JNIEXPORT jdouble JNICALL Java_com_prouast_heartbeat_RPPG__1temperature
  (JNIEnv *, jclass, jlong ,jint, jdouble, jdouble, jint, jint, jint, jdouble, jdouble, jdouble, jdouble);
// JNIEXPORT jdouble JNICALL Java_com_prouast_heartbeat_RPPG__1output_temperature
   // (JNIEnv *, jclass, jlong, jint, jdouble, jdouble, jint, jint, jint, jdouble, jdouble, jdouble, jdouble);
