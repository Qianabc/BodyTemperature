...
// }
 JNIEXPORT jdouble JNICALL Java_com_prouast_heartbeat_RPPG__1temperature
 (JNIEnv *jenv, jclass, jlong self, jint jage,jdouble jmeasure_time_diff, jdouble jsleep_time_diff, jint jmodechoose, jint jhr_standard,jint jgender_flag, jdouble jmeasure_interval, jdouble jstore_bpms, jdouble jstore_te, jdouble jnow_bpms) {
     LOGD("Java_com_prouast_heartbeat_RPPG__1output_reference enter");
     jdouble result_te = 0;
     try {
         result_te = ((RPPG *)self)->temperature(jage, jmeasure_time_diff, jsleep_time_diff, jmodechoose, jhr_standard, jgender_flag, jmeasure_interval, jstore_bpms, jstore_te, jnow_bpms);
     } catch (...) {
         jclass je = jenv->FindClass("java/lang/Exception");
         jenv->ThrowNew(je, "Unknown exception in JNI code.");
     }
